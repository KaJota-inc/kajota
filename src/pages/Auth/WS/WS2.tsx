...
const WS2 = ({ onSkip, onGetStarted }: IProps) => {
  return (
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.r2}>
            <Image resizeMode="contain" source={IMAGES.FrameWS2sub} style={styles.r2t} />
          </View>
        </ImageBackground>
        <View style={styles.r3}>
          <Text style={styles.r3t}>Reliable & Quality delivery worldwide</Text>
        </View>
        <View style={styles.slider}>
          {[1, 2, 3].map((_, idx) => (
            <View key={nanoid()} style={styles.slide}>
              <Octicons
                color={idx + 1 === 2 ? COLORS.light.colorOne : COLORS.light.colorOneLight}
                name="dot-fill"
                size={23}
              />
            </View>

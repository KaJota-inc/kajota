    ...
    <>
      ...
      <View style={styles.r3}>
        <Text style={styles.r3t1}>
          Choose your preferred way to utilize Jota's services.
        </Text>
      </View>

      {utilityOptions.map((opt, idx) => (
        <TouchableOpacity
          key={nanoid()}
        ...
        >
          <View style={styles.radioButton}>
            <MaterialIcons
              color={
                selectedItemIndex === idx ? COLORS.light.colorOne : COLORS.light.active
              }
              name={
                selectedItemIndex === idx ? 'radio-button-on' : 'radio-button-unchecked'
              }
              size={24}
            />
          </View>

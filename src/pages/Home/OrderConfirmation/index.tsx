...
import { ConfirmationLogoSVG, PickAPLanSVG } from '@shared/components/SVGS';
...
type NavigationProps = CompositeScreenProps<
  HomeProps<HomeRoutes.ORDERCONFIRMATION>,
  RootScreenProps<RootRoutes.Home>
>;

const OrderConfirmation: React.FC<NavigationProps> = ({ navigation }) => {
  const handleContinue = async () => {
    debug.log('here');
    navigation?.navigate(HomeRoutes.ORDERRATING);
  };
          ...
          <View style={styles.r2}>
            <View style={styles.r6}>
              ...
              <View style={styles.r1}>
                <Text style={styles.r1t2}>Order Confirmation</Text>
              </View>
              <View style={styles.r3}>
                <Text style={styles.r3t1}>
                  Thank you for your purchase! Your satisfaction matters. Please confirm
                  below if you're satisfied with your product.
                </Text>
              </View>
            </View>
